...
import ServiciosLista from "./pages/ServicioLista";
    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/about" element={<Navigate to="/about" />}></Route>
          ...
          <Route path="/servicios" element={<Servicios />}>
            <Route path="homeservice" element={<HomeServices />}></Route>
            <Route path="garantia" element={<Garantia />}></Route>
            <Route index element={<Politicas />}></Route>
            <Route
              path="lista"
